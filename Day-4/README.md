...
Implemented Middleware which logs the request in the log.txt. Also implemented templating using pug template engine to display the response on the webpage. Learned an implemented serving static files on the webpage using express middleware.
...
```
http://localhost:3000/api/employee/ping
```
This is a GET request and it is used to "get" the status of backend.
